...
const categoryIcons = [
  { icon: <IoShirtOutline size={40} />, label: "Doces" },
  { icon: <PiPantsLight size={40} />, label: "Tortas" },
  { icon: <PiBaseballCapLight size={40} />, label: "Bolos" },
  { icon: <PiHeadphonesLight size={40} />, label: "Sobremesas" },
  { icon: <GiConverseShoe size={40} />, label: "Dindins" },
];

const productsData = [
  { id: 1, name: "Torta foda", image: "https://th.bing.com/th/id/OIP.qxh9d7Rd0beagqUWCh3oEgHaFY?w=243&h=180&c=7&r=0&o=7&pid=1.7&rm=3", price: 200, priceDiscount: 149.9, category: "Torta" },
  { id: 2, name: "Bolo foda", image: "https://th.bing.com/th/id/OIP.z2DjpZnfHGHlIP005yG7ygHaJQ?w=203&h=254&c=7&r=0&o=7&pid=1.7&rm=3", price: 200, category: "Bolo", priceDiscount: 180 },
  { id: 3, name: "Nenen linda", image: "https://a-static.mlcdn.com.br/800x560/tenis-puma-rs-x-3d-masculino/b2online/3943110242/53502c5bb7a4aca0addb96f6ac8635a6.jpeg", price: 99.9, category: "Sobremesas", priceDiscount: 89.9 },
  { id: 4, name: "Dindin", image: "https://th.bing.com/th/id/OIP.Om37xOE0WmqhdzzszAst3wHaGP?w=220&h=185&c=7&r=0&o=7&pid=1.7&rm=3", price: 150, category: "Dindins", priceDiscount: 120 },
